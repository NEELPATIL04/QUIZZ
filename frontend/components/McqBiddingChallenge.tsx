...
export default function McqBiddingChallenge({
  ...
  const canBid = !bidSubmitted && timerState && !timerState.biddingClosed;
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-900 via-cyan-900 to-blue-900 p-8">
      ...
      <div className="mb-6 flex items-center justify-between max-w-7xl mx-auto">
        <div>
          ...
          <h1 className="text-3xl font-bold text-white">Team {teamNumber}</h1>
        </div>
          ...
          <CardContent className="py-3 px-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-900">{teamScore} pts</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-3 gap-6 max-w-7xl mx-auto">
        ...
        <div className="col-span-1">
          <Card className={`bg-white/95 border border-slate-200 shadow-lg h-full ${
            !timerState?.answerRevealed ? 'relative overflow-hidden' : ''
          }`}>
            <CardContent className="p-4">
